...
Front (`plataforma`) y back (`Plataformaback`) usan **la misma versión**. Si cada quien instala Node “el de ahora”, el `package-lock.json` cambia y salen conflictos al clonar.
...
- **No Node 22 ni 20.** Este backend es **AdonisJS 7** y declara `node >= 24.0.0`. Con 22 el API ni arranca.
